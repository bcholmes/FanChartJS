...
exports.getProperty = function(obj, propString) {
...
exports.stripTrailing = function(string, suffix) {
	return exports.endsWith(string, suffix) ? string.substring(0, string.lastIndexOf(suffix)) : string;
}
